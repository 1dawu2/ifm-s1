...
function block0(context, tags, suffix) { return html `<section class="ui5-carousel-root" tabindex="0" role="listbox" aria-activedescendant="${ifDefined(this.ariaActiveDescendant)}" @focusin="${this._onfocusin}" @keydown=${this._onkeydown} @mouseout="${this._onmouseout}" @mouseover="${this._onmouseover}"><div class="${classMap(this.classes.viewport)}" part="content"><div class="${classMap(this.classes.content)}" style="${styleMap(this.styles.content)}">${repeat(this.items, (item, index) => item._id || index, (item, index) => block1.call(this, context, tags, suffix, item, index))}</div></div>${this.showArrows.content ? block2.call(this, context, tags, suffix) : undefined}${this.renderNavigation ? block3.call(this, context, tags, suffix) : undefined}</div></section> `; }
...
function block8(context, tags, suffix) { return suffix ? html `<${scopeTag("ui5-label", tags, suffix)}>${ifDefined(this.selectedIndexToShow)}&nbsp;${ifDefined(this.ofText)}&nbsp;${ifDefined(this.pagesCount)}</${scopeTag("ui5-label", tags, suffix)}>` : html `<ui5-label>${ifDefined(this.selectedIndexToShow)}&nbsp;${ifDefined(this.ofText)}&nbsp;${ifDefined(this.pagesCount)}</ui5-label>`; }
