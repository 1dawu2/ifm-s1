...
<body>
	...
	<ui5-dialog id="draggable-dialog" accessible-name="Draggable" draggable>
		<div id="tlt" slot="header"  class="dialog7auto">Draggable dialog</div>
	...
	<ui5-dialog id="draggable-and-resizable-dialog" header-text="Draggable & resizable dialog" draggable resizable>
		<p>Move this dialog around the screen by dragging it by its header or use the arrow keys.</p>
		<p>Resize this dialog by dragging it by its resize handle or use shift+arrow keys.</p>
		<p>This feature is available only on Desktop.</p>
